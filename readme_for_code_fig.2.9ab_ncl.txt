##########################################################################
# ---------------------------------------------------------------------------------------------------------------------
# This is NCL code to produce IPCC AR6 WGI Figure 2.9a,b*
# Creator: Johannes Quaas, Leipzig University
# Contact: johannes.quaas@uni-leipzig.de
# Last updated on: 24 November 2021
# --------------------------------------------------------------------------------------------------------------------
#
# - Code functionality: Plot the ice core data
# - Input data: Ice core data converted using tx2nc.ksh
# - Output variables: Fig 2.9a,b
#
# ----------------------------------------------------------------------------------------------------
